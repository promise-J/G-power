...
const Sidebar = ({showSidebar, setShowSidebar}) => {
  ...
  return (
    <div style={{background: '#100522'}} className='sidebar h-[100vh] fixed px-1 pb-[100px] z-[200]'>
      ...
      <div style={{background: '#9681eb'}} className='flex items-center w-[90%] rounded-xl px-1 py-3'>
        <img className='h-12 w-12 rounded-full' src="https://res.cloudinary.com/dfohdw1w8/image/upload/v1712659773/gp_fmgx1a.png" alt="admin-img" />
      ...
      <ul style={{transition: '3s'}} className={`px-4 min-w-[300px] mt-4`}>
        <Link to={'/gp-admin/dashboard'} onClick={()=> setShowSidebar(false)}>
        ...
        <Link to={'/gp-admin/dashboard/members'} onClick={()=> setShowSidebar(false)}>
        <li className='flex cursor-pointer items-center px-1 py-3'><RxDashboard className='hover:text-purple-200' color='white' /> <span className='ms-3 text-gray-500 hover:text-purple-200 duration-200'>Members</span></li>
        </Link>
        <Link to={'/gp-admin/dashboard/media-headers'} onClick={()=> setShowSidebar(false)}>
        <li className='flex cursor-pointer items-center px-1 py-3'><RxDashboard className='hover:text-purple-200' color='white' /> <span className='ms-3 text-gray-500 hover:text-purple-200 duration-200'>Media headers</span></li>
        </Link>
        ...
        <Link to={'/gp-admin/dashboard/manage-audio'} onClick={()=> setShowSidebar(false)}>
        <li className='flex cursor-pointer items-center px-1 py-3'><RxDashboard className='hover:text-purple-200' color='white' /> <span className='ms-3 text-gray-500 hover:text-purple-200 duration-200'>Manage Audio</span></li>
        </Link>
      </ul>
